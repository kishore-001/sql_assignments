...
```
sql_assignments/sql1/
├── ans/
│   ├── n1.png - n10.png (Basic Questions)
│   ├── i1.png - i15.png (Intermediate Questions)
│   ├── a1.png - a12.png (Advanced Questions)
│   └── s1.png - s10.png (Super-Advanced Questions)
└── README.md
```
...
- **Table Operations (CREATE, INSERT, DELETE)**
- **SELECT Queries (Basic & Advanced)**
- **Aggregate Functions (COUNT, SUM, AVG, MAX)**
- **Filtering & Conditions (WHERE, BETWEEN)**
- **JOIN Operations (INNER, LEFT, FULL OUTER)**
- **String Functions (SPLIT, CONCAT)**
...
- All screenshots are organized by difficulty level
- Answer images are stored in the `ans/` directory
- Follow the naming convention: `[level][number].png`
  - `n` = Basic
  - `i` = Intermediate
  - `a` = Advanced
  - `s` = Super-Advanced
